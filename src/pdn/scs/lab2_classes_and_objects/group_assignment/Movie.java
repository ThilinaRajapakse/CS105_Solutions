package pdn.scs.lab2_classes_and_objects.group_assignment;
...
public class Movie
{
    ...
    public static void main(String[] args)
    {
        ...
        Movie.averageRating = (movie1.rating + movie2.rating + movie3.rating) / 3;
        System.out.println("Average rating: " + Movie.averageRating);

        Movie movie4 = movie1;  // Copy the reference contained in movie1 variable to movie4. Both variables now
